...
public class OrderController {
    ...
    @RequestMapping("/findByUserid")//  http://localhost:2227/order/findByUserid/?userid=1
    ...
    @RequestMapping("/findById")// http://localhost:2227/order/findById/?id=1
    ...
    @RequestMapping("/name")// http://localhost:2227/order/name/?id=1
